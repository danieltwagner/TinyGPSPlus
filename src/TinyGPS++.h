...
private:
  enum {
    GPS_SENTENCE_GGA,  // GGA - Global Positioning System Fix Data
    GPS_SENTENCE_RMC,  // RMC - Recommended Minimum Navigation Information

    GPS_SENTENCE_GSA,  // GSA - GPS DOP and active satellites
    GPS_SENTENCE_GSV,  // GSV - Satellites in view
